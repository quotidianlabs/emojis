...
new Picker({
  data: async () => {
    const response = await fetch(
      'https://cdn.jsdelivr.net/npm/@quotidianlabs/emojis-data@0.3/sets/16/native.json',
    )
...
| **emojiVersion** | `16` | `1`, `2`, `3`, `4`, `5`, `11`, `12`, `12.1`, `13`, `13.1`, `14`, `15`, `15.1`, `16` | The Emoji Version of the Data to use. Latest version supported in `@quotidianlabs/emojis-data` is currently [16](https://emojipedia.org/emoji-16.0) |

...
async function _init(props) {
  ...
  if (!Data) {
    Data =
      ...
      (await fetchJSON(
        `https://cdn.jsdelivr.net/npm/@quotidianlabs/emojis-data@0.2/sets/${emojiVersion}/${set}.json`,
      ))
  ...
  I18n =
    ...
    (locale == 'en'
      ? i18n_en
      : await fetchJSON(
          `https://cdn.jsdelivr.net/npm/@quotidianlabs/emojis-data@0.2/i18n/${locale}.json`,
        ))

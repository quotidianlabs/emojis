  ...
  const imageSrc =
    ...
    (props.set != 'native' && !props.spritesheet
      ? typeof props.getImageURL === 'function'
        ...
        : `https://cdn.jsdelivr.net/npm/emoji-datasource-${props.set}@${DATASOURCE_VERSION}/img/${props.set}/64/${emojiSkin.unified}.png`
      : undefined)

  const spritesheetSrc =
    typeof props.getSpritesheetURL === 'function'
      ? props.getSpritesheetURL(props.set)
      : `https://cdn.jsdelivr.net/npm/emoji-datasource-${props.set}@${DATASOURCE_VERSION}/img/${props.set}/sheets-256/64.png`
